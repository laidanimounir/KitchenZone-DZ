      ...
      <div className="relative z-10 h-full flex flex-col justify-center px-8 md:px-20 max-w-3xl">
        ...
        >
          ...
          <a
            ...
            className="group flex items-center gap-3 px-8 py-4 bg-[#25D366] text-white rounded-full text-sm font-medium hover:bg-[#1ebe5d] transition-all duration-300"
          >
          ...
          {stats.map(({ value, suffix, label }) => (
            <div key={label} className="flex flex-col gap-1">
              <span className="text-3xl md:text-4xl font-bold text-white">
                <CountUp to={value} suffix={suffix} start={startCount} />
              </span>
